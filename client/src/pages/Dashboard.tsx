...
const chartData=[{day:'Mon',value:34},{day:'Tue',value:46},{day:'Wed',value:39},{day:'Thu',value:62},{day:'Fri',value:54},{day:'Sat',value:71},{day:'Sun',value:64}]
export function Dashboard({refreshKey=0}:{refreshKey?:number}){
 ...
 return <div className="dashboard-page">
  <div className="page-hero"><div><p className="eyebrow">TUESDAY · OPERATIONS</p><h1>Good evening<span>.</span></h1><p className="hero-sub">A live pulse of what needs attention across XYZ Company.</p></div><div className="hero-orbit"><div className="orbit-core"><Activity size={19}/></div><span className="orbit-dot d1"/><span className="orbit-dot d2"/><span className="orbit-dot d3"/></div></div>
  ...
  <div className="dashboard-grid">
   <Card className="chart-card"><div className="section-head"><div><p className="eyebrow">OPERATIONS VELOCITY</p><h3>Weekly activity</h3></div><Badge tone="success">Live data</Badge></div><div className="chart-wrap"><ResponsiveContainer width="100%" height="100%"><AreaChart data={chartData}><defs><linearGradient id="v" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#8b5cf6" stopOpacity=".34"/><stop offset="100%" stopColor="#8b5cf6" stopOpacity="0"/></linearGradient></defs><XAxis dataKey="day" axisLine={false} tickLine={false} tick={{fill:'#747b8d',fontSize:11}}/><Tooltip contentStyle={{background:'#161922',border:'1px solid #2a2f3b',borderRadius:12,color:'#fff'}}/><Area type="monotone" dataKey="value" stroke="#9b7bff" strokeWidth={2.5} fill="url(#v)"/></AreaChart></ResponsiveContainer></div></Card>
